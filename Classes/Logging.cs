                ...
                case LogSeverity.Critical:
                    lock (CriticalLogLock)
                    {
                        try
                        {
                            ...
                            CriticalLogWriter.WriteLine($":: {DateTime.Now} ::");
                ...
                case LogSeverity.Error:
                    lock (ErrorLogLock)
                    {
                        try
                        {
                            ...
                            ErrorLogWriter.WriteLine($":: {DateTime.Now} ::");
                ...
                case LogSeverity.Warning:
                    lock (WarningLogLock)
                    {
                        try
                        {
                            ...
                            WarningLogWriter.WriteLineAsync($":: {DateTime.Now} ::");
                ...
                case LogSeverity.Info:
                    lock (InfoLogLock)
                    {
                        try
                        {
                            ...
                            InfoLogWriter.WriteLine($":: {DateTime.Now} ::");
                ...
                case LogSeverity.Verbose:
                    lock (VerboseLogLock)
                    {
                        try
                        {
                            ...
                            VerboseLogWriter.WriteLineAsync($":: {DateTime.Now} ::");
                ...
                case LogSeverity.Debug:
                    lock (DebugLogLock)
                    {
                        try
                        {
                            ...
                            DebugLogWriter.WriteLineAsync($":: {DateTime.Now} ::");
